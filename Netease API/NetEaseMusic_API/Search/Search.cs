...
namespace MusicApi.NetEase.Search
{
    ...
    public sealed class Search : BaseRequestOption
    {
        ...
        public Search(Hashtable cookie, string keyword) : this(cookie, keyword, SearchType.Song, 10, 0)
        {
        }

        public Search(Hashtable cookie, string keyword, SearchType searchType) : this(cookie, keyword, searchType, 10, 0)
        {
        }
