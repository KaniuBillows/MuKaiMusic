...
namespace MusicApi.Migu.Music
{
    public class Web_Listen_Url : BaseRequestOption
    {
        public Web_Listen_Url(Hashtable cookies) : base(cookies)
        {

        }

        public Web_Listen_Url(string copyRightId) : this(new Hashtable())
        {
